...
const DATA_FILES = {
  ...
  vestelBasicOffpeakPolicy: 'vestel-basic-offpeak-policy.json',
  vestelBasicRfidPolicy: 'vestel-basic-rfid-policy.json',
  vestelBasicOtherPolicy: 'vestel-basic-other-policy.json',
  vestelSmartchargeVioletPolicy: 'vestel-smartcharge-violet-policy.json',
  vestelSmartchargeTripPolicy: 'vestel-smartcharge-trip-policy.json',
  vestelSmartchargeLowChargePolicy: 'vestel-smartcharge-low-charge-policy.json',
  vestelSmartchargeNoStartPolicy: 'vestel-smartcharge-no-start-policy.json',
  vestelSmartchargeApplicationPolicy: 'vestel-smartcharge-application-policy.json',
  vestelSmartchargeOtherPolicy: 'vestel-smartcharge-other-policy.json',
...
export async function loadData(baseUrl = '../data/') {
  ...
  data.nodes = applySchneiderChargePolicy(data.nodes, data.vestelBasicOffpeakPolicy);
  data.nodes = applySchneiderChargePolicy(data.nodes, data.vestelBasicRfidPolicy);
  data.nodes = applySchneiderChargePolicy(data.nodes, data.vestelBasicOtherPolicy);
  data.nodes = applySchneiderChargePolicy(data.nodes, data.vestelSmartchargeVioletPolicy);
  data.nodes = applySchneiderChargePolicy(data.nodes, data.vestelSmartchargeTripPolicy);
  data.nodes = applySchneiderChargePolicy(data.nodes, data.vestelSmartchargeLowChargePolicy);
  data.nodes = applySchneiderChargePolicy(data.nodes, data.vestelSmartchargeNoStartPolicy);
  data.nodes = applySchneiderChargePolicy(data.nodes, data.vestelSmartchargeApplicationPolicy);
  data.nodes = applySchneiderChargePolicy(data.nodes, data.vestelSmartchargeOtherPolicy);
